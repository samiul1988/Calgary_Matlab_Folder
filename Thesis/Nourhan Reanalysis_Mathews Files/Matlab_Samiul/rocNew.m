function ROCout=rocNew(varargin)
...
elseif nu>6
    error('Warning: Max six input data are required')
end
...
150 0;205 0;163 0;166 0;176 0;],0,0.05,1,'k',''};
default.values(1:nu) = args;
[x threshold alpha verbose colorName legendName] = deal(default.values{:});
if isvector(x)
...
%     figure;
%     subplot(1,2,1)
    HR1=plot(xroc,yroc,'.-','Color',colorName);
    hold on
    HRC1=plot([0 1],[0 1],'g');
%     plot([0 1],[1 0],'g')
%     hold on
