...
maxConsRejections = 1000; % maximum number of consecutive rejections
maxTry = 300; % maximum number of tries within one temperature
maxSuccess = 20; % maximum number of success within one temperature
...
%     current = parent; 
    ...
    trainIndex = randi(sampleNum,1,nTrainPt); %% random sample 'with replacements'
    testIndex = setdiff(1:sampleNum, trainIndex);
