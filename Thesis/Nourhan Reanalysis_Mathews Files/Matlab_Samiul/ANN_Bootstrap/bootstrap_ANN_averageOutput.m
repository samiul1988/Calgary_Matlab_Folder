...
%%% Properties for pattern recognition neural network ....get property object for neural network
hiddenLayerSize = 3;
ann_GUI;
...
for boot = 1:numBoot_out
        ...
        for i = 1: numBoot_in
            ...
            [net, tr] = train(net,trainX,trainT); %%% train and retrain the same network numBoot_in times
            % plotperform(tr)
...
fileName = strcat('ANN_bootInp_',num2str(featureNum),'11_HLS',num2str(hiddenLayerSize),generateFileNameForANN(data.header));
